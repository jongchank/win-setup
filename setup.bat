...
winget install -e --id Dropbox.Dropbox --silent --accept-package-agreements --accept-source-agreements
...
winget install -e --id Kakao.KakaoTalk --silent --accept-package-agreements --accept-source-agreements
